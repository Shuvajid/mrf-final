...
<div class="container-fluid pt-5 pb-3">
        ...
        @foreach($prodetails as $pro)
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{asset('/images/'.$pro->images)}}" alt="">
                               
                            </div>
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none " href="{{route('details',$pro->id)}}">{{$pro->pro_name }}</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{$pro->price }} BDT</h5><h6 class="text-muted ml-2"></h6>
                                </div>
                               <br>
            ...
            @endforeach
                    <div class="col-12">
                        {{ $prodetails->links('vendor.pagination.paginate') }} 
                    </div>
    </div>
</div>
    <!-- Products End -->
