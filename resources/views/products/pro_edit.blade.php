...
@section('content')
  ...
  <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <form id="myForm" method="POST" id="myForm" action="{{route('update_pro',$product->model)}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>Image</label>
                            <img src= "{{asset('/images/'.$product->images)}}" style="width:504px;height:228px"> 
                            <input class="form-control" type="file" placeholder="" name="images" value="">
                        </div>
                    </div>
